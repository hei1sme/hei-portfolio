...
const milestones: Milestone[] = [
  {
    ...
    year: '2025',
    title: 'SpeedyLabX',
    tagline: 'Founded student research incubator group',
    icon: <FaRocket />,
    color: '#ec4899',
  ...
  },
  {
    ...
    tagline: 'SmokeNet accepted at AJCAI 2025 (Q2 LNAI)',
    icon: <FaFileAlt />,
    color: '#a855f7',
  ...
  },
  {
    ...
    month: 'January',
    year: '2026',
    title: 'AJCAI 2026 Submission',
    tagline: 'Cyanobacterial Bloom Forecasting (Under Review)',
    icon: <FaFileAlt />,
    color: '#22c55e',
    image: '/images/experience/2_SmokeNet/2_1_SN.jpg',
    stat: { value: '0.791', label: '7-day weighted F1' },
  },
  {
    id: 'kdd2027',
    month: 'January',
    year: '2026',
    title: 'ACM SIGKDD 2027',
    tagline: 'Trustworthy Multimodal Anomaly Detection (Under Review)',
    icon: <FaFileAlt />,
    color: '#3b82f6',
    image: '/images/experience/2_SmokeNet/2_1_SN.jpg',
    stat: { value: '94.3%', label: 'attribution accuracy' },
  },
];
